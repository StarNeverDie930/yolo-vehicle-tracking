...
def test():
    with open('/home/train/UA-DETRAC/train_gt.txt', 'r') as f:
        gt = f.readlines()
    with open('/home/train/UA-DETRAC/train_ign.txt', 'r') as f:
        ign = f.readlines()
    base_dir = '/home/train/UA-DETRAC/DETRAC-train-data/Insight-MVT_Annotation_Train/'
